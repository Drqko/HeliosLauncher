...
// Constants
const clientId = 'd3f9174f-7aef-4863-a07d-c8df119cbe35'
        ...
        requestPromise(authXSTSUri, options).then(response => {
            if (response.body.XErr) {
                switch (response.body.XErr) {
                    ...
                    case 2148916238: 
                        reject({
                            message: 'Since you are not yet 18 years old, an adult must add you to a family in order for you to use the Vyzor Launcher!'
                        })
                        return

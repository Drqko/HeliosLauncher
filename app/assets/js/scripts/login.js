...
ipcRenderer.on('MSALoginWindowReply', (event, ...args) => {
    ...
    if (queryMap.has('error')) {
        ...
        if(error === 'access_denied'){
            error = 'ERROR'
            errorDesc = 'To use the Vyzor Launcher, you must agree to the required permissions! Otherwise you can\'t use this launcher with Microsoft accounts.<br><br>Despite agreeing to the permissions you don\'t give us the permission to use your account as all information is sent to Microsoft.'
        }        
